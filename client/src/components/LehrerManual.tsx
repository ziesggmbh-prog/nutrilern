    ...
    <div>
      ...
      <div className="space-y-4">
        ...
        <AccordionSection number={1} title="Kohlenhydrate" color="bg-green-600" bgColor="bg-green-50" textColor="text-green-800" isOpen={!!openSections[1]} onToggle={() => toggle(1)}>
          ...
          <SubSection icon={<div className="w-7 h-7 bg-blue-100 rounded-full flex items-center justify-center"><span className="relative block" style={{width:'14px',height:'12px'}}><span className="absolute text-blue-300 font-normal" style={{fontSize:'9px',top:'0px',left:'0px'}}>?</span><span className="absolute text-blue-500 font-normal" style={{fontSize:'9px',top:'2px',left:'4px'}}>?</span><span className="absolute text-blue-700 font-normal" style={{fontSize:'9px',top:'4px',left:'8px'}}>?</span></span></div>} title="Vertiefende Fragen">
