    ...
    <div>
      ...
      <div className="space-y-4">
        ...
        <AccordionSection number={1} title="Kohlenhydrate" color="bg-green-600" bgColor="bg-green-50" textColor="text-green-800" isOpen={!!openSections[1]} onToggle={() => toggle(1)}>
          ...
          <SubSection icon={<div className="w-7 h-7 bg-blue-100 rounded-full flex items-center justify-center"><span className="relative inline-flex items-center justify-center w-full h-full"><span className="absolute text-blue-300 font-normal text-xs" style={{top:'1px',left:'3px'}}>?</span><span className="absolute text-blue-500 font-normal text-xs" style={{top:'3px',left:'6px'}}>?</span><span className="absolute text-blue-700 font-normal text-xs" style={{top:'5px',left:'9px'}}>?</span></span></div>} title="Vertiefende Fragen">
