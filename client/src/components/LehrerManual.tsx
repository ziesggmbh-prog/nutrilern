    ...
    <div>
      ...
      <div className="space-y-4">
        ...
        <AccordionSection number={1} title="Kohlenhydrate" color="bg-green-600" bgColor="bg-green-50" textColor="text-green-800" isOpen={!!openSections[1]} onToggle={() => toggle(1)}>
          ...
          <SubSection icon={<div className="w-7 h-7 bg-blue-100 rounded-full flex items-center justify-center"><span className="text-blue-600 font-bold text-base leading-none">?</span></div>} title="Vertiefende Fragen">
