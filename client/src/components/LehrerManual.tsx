...
function DocImage({ src, caption, maxHeight = 170 }: { src: string; caption: string; maxHeight?: number }) {
  return (
    <figure className="my-3 flex flex-col items-center">
      <img src={src} alt={caption} className="max-w-full rounded-md border border-gray-200 bg-white" style={{ maxHeight: `${maxHeight}px`, objectFit: "contain" }} />
      ...
      <div className="space-y-4">
        ...
        <AccordionSection number={1} title="Kohlenhydrate" color="bg-green-600" bgColor="bg-green-50" textColor="text-green-800" isOpen={!!openSections[1]} onToggle={() => toggle(1)}>
          ...
          <SubSection icon={<div className="w-7 h-7 bg-indigo-100 rounded-full flex items-center justify-center"><Lightbulb className="text-indigo-600" size={14} /></div>} title="Weiterführende Informationen">
            ...
            <DocImage src="/manual-images/image4.png" caption="Struktur der Amylose" maxHeight={42} />
