      ...
      >
        <div className="relative z-10">
          <div className="flex items-center justify-between mb-4">
            <div className={`${isCompleted ? "bg-green-custom" : isAvailable ? colorClass : "bg-gray-600"} rounded-full w-10 h-10 shrink-0`} style={{ display: 'grid', placeItems: 'center' }}>
              <Calendar className="text-white" size={16} />
            </div>
            <div className={`${isCompleted ? "bg-green-custom" : isAvailable ? colorClass : "bg-gray-600"} rounded-full w-8 h-8 shrink-0`} style={{ display: 'grid', placeItems: 'center' }}>
              {isCompleted ? (
