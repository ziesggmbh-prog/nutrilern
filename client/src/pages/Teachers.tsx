          ...
          <div className="mb-12">
            ...
            <div className="prose max-w-none text-gray-700 leading-relaxed">
              ...
              <ul className="list-disc pl-6 space-y-3">
                ...
                <li>Das Hintergrundwissen einer Lektion, auch zur Beantwortung der vertiefenden Fragen, wird durch die Informationen im <Link href="/teachers" className="underline text-blue-600 hover:text-blue-800">Lehrer:innenmanual</Link> abgedeckt. Dort finden sich Zusammenfassungen der Lehrfilme, die vertiefenden Fragen und weiterführende Informationen.</li>
